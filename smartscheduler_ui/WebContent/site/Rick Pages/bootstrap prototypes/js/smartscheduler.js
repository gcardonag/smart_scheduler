    ...
    $('#submitBtn').click(function(){
       ...
       //('#rightCol #accordionEventsList').append("<p>Name: " + eventName + "</p> <p>startTime: " + startTime + "</p>" + "<ul><li>End Time: "+endTime+"</li><li>Start Time: "+startDate+"</li><li>End Date: "+endDate+"</li></ol>");
        ...
        $('#rightCol #accordionEventsList').append(
            "
                <div class='accordion-group'><div class='accordion-heading'><a class='accordion-toggle' data-toggle='collapse' data-parent='#accordionEventsList' href='#collapse" +eventName+ "' style='background-color: #46a546'>
                        <strong style='color:white'>" + eventName + "</strong></a></div><div id='collapse"+eventName+ "' class='accordion-body collapse'>
                        <div class='accordion-inner'><dl class='dl-horizontal'><dt>Name:</dt>
                                <dd>" + eventName + "</dd>
                                <dt>Start Time:</dt>
                                <dd>" + startTime + "</dd>
                                <dt>End Time:</dt>
